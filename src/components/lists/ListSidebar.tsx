        ...
        <aside className="lg:col-span-4 space-y-6 h-[700px] overflow-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                <div className="p-4 border-b border-gray-50 bg-gray-50/50 flex items-center justify-between">
                    ...
                    <span className="text-xs font-medium bg-gray-200 text-gray-600 px-2 py-1 rounded-full">{lists.length}</span>
                </div>
                    ...
                    {lists.length === 0 ? (
                        ...
                        lists.map((l) => (
                            <button
                                ...
                                className={`w-full p-3 text-left rounded-lg transition-all border cursor-pointer ${currentListId === (l._id || l.id)
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mt-1 text-xs opacity-70">
                                    ...
                                    <span>{l.createdAt ? new Date(l.createdAt).toLocaleDateString() : 'No Date'}</span>
                                </div>
                            </button>
                        ))
                    )}
